...
List<sensebox_model.Sensor> sortApiSensorsByCanonicalOrder(
    List<sensebox_model.Sensor> sensors) {
...
int getUiPriorityByUuid(String characteristicUuid) {
  final uuidToPriority = {
    ...
    DCISensor.sensorCharacteristicUuid: DCISensor.staticUiPriority,
