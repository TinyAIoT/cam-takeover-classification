...
#SBATCH --output /scratch/tmp/%u/cam-takeover-classification/tmp/deploy_%j.log
...
python "$code"/deployment/apply_trained-make_mosaic.py \
    --input_folder /scratch/tmp/p_scha35/cam-takeover-classification/data/split_classified/test/takeover \
    --model_path /scratch/tmp/p_scha35/cam-takeover-classification/results/torch_squeezy_2/torch_squeezy_2/torch_squeezy_2_fine_tuning.pth \
    --output /scratch/tmp/p_scha35/cam-takeover-classification/results/torch_squeezy_2/torch_squeezy_2/mosaic_takeover.jpg \
    --mean 0.485,0.456,0.406 \
    --std 0.229,0.224,0.225 \
    --input-size 96 \
    --classes not_takeover,takeover "$@"

python "$code"/deployment/apply_trained-make_mosaic.py \
    --input_folder /scratch/tmp/p_scha35/cam-takeover-classification/data/split_classified/test/not_takeover \
    --model_path /scratch/tmp/p_scha35/cam-takeover-classification/results/torch_squeezy_2/torch_squeezy_2/torch_squeezy_2_fine_tuning.pth \
    --output /scratch/tmp/p_scha35/cam-takeover-classification/results/torch_squeezy_2/torch_squeezy_2/mosaic_not_takeover.jpg \
    --mean 0.485,0.456,0.406 \
    --std 0.229,0.224,0.225 \
    --input-size 96 \
    --classes not_takeover,takeover "$@"

echo "end of deployment for Job "$SLURM_JOB_ID" :"
